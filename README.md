...
Hai thứ quan trọng cần phải biết để có thể tấn công SQLi là "--" và lệnh "UNION". Nếu "--" xuất hiện trong một câu lệnh, nó sẽ bỏ qua tất cả mọi thứ phía sau nó (giống "//" trong C và "#" trong Python). Còn lệnh "UNION" được sử dụng để kết hợp kết quả của nhiều truy vấn.
